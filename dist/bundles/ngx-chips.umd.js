(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var TagInputComponent = /** @class */ (function (_super) {
        ...
        TagInputComponent.prototype.onFormSubmit = function ($event) {
            return __awaiter(this, void 0, void 0, function () {
                var isIMEProcessing, _a_1;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 4, , 5]);
                            isIMEProcessing = $event && ($event.isComposing || $event.key === 'Process' || $event.keyCode === 229);
                            if (!isIMEProcessing) return [3 /*break*/, 1];
                            $event.preventDefault();
                            return [3 /*break*/, 3];
                        case 1: return [4 /*yield*/, this.onAddingRequested(false, this.formValue)];
                        case 2:
                            _b.sent();
                            _b.label = 3;
        ...
        TagInputComponent.prototype.setupSeparatorKeysListener = function () {
            ...
            var listener = function ($event) {
                ...
                var isIMEProcessing = $event.isComposing || $event.key === 'Process' || $event.keyCode === 229;
